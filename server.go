...
import (
	...
	"github.com/mishudark/kit/log"
)

// Handler decodes the passed request and calls the business logic
...
func ServerErrorLogger(logger log.Logger) ServerOption {
	return func(s *Server) { s.errorHandler = NewLogErrorHandler(logger) }
}
